...
**Linux and Mac: `Failed parsing new quests.` in your log?** Linux and Mac players may see this error in the SMAPI log when Ridgeside Village quest data fails to parse. Install [Ridgeside Village Quest Fix For Linux and Mac](https://www.nexusmods.com/stardewvalley/mods/36004) to patch it.
