...
- **Linux and Mac only** (including Steam Deck on Linux runtime)
...
- See [Ridgeside Village](mod-issues.md#ridgeside-village) in Mod-Specific Known Issues for more context
