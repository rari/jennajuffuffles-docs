...
- [3. Manage Rules](#3-manage-rules)
  ...
  - [When Vortex asks you to set rules](#when-vortex-asks-you-to-set-rules)
...
**Manage Rules** controls the **load order** of your mods from staging to deployment. This is crucial for mods that modify the same files.
...
- Set your 'VERY Configured' to load **After All** (for multi-collections, set svVe last)
...
During **install** or **collection update**, Vortex may still open **Manage Rules** and ask you to finish unresolved rules. If that happens, follow [When Vortex asks you to set rules](#when-vortex-asks-you-to-set-rules) below before you play.
...
2. Click **Manage Rules**
3. Scroll through the list and find each **VERY Configured** entry (you may see one per collection, e.g. Stardew Valley VERY Expanded, Aesthetic Valley Fairycore)
...
**Never use "Use Suggested"** for this. Suggested rules can create loops or wrong load order.
