...
When building your collection, you may notice that some mods display an error in Vortex. Mods that have been added to Vortex, particularly those installed manually or from uncompressed folders, may not have sufficient source information in Vortex to upload as part of a collection.
...
If a mod shows an error, you'll need to remove it from your profile, download it properly through Vortex or as a ZIP from Nexus Mods, and reinstall it before including it in your collection.
