---
title: Using Controllers with Mod Collections
description: Use controllers and gamepads with Stardew Valley mod collections. Learn about controller support, keybind customization via GMCM, and controller-specific setup.
keywords: [controller, gamepad, keybinds, GMCM, controller support, Stardew Valley controllers, gamepad setup]
tags: [controller, gamepad, keybinds]
---
...
- [New Player Install Instructions](index.md) - Main installation guide
- [Troubleshooting & FAQ](../Troubleshooting/index.md) - For additional help
- [About the Collections](../About/index.md) - Collection-specific keybind information
